            ...
            .collection
                .fetch( {
                    ...
                    "success": function() {
                        ...
                        that.views.main.loading( false, oTerminalsCollection.length + " distributeurs à proximité" );
                    }
                } );
    },
...
},{"./collections/terminals":2,"./models/terminal":3,"./views/admin":5,"./views/header":6,"./views/main":7,"./views/terminal-details":8,"./views/terminals-list":10,"backbone":"backbone","jeolok":"jeolok","jquery":"jquery","underscore":"underscore"}],5:[function(require,module,exports){
/* Chèch Lajan
 *
...
},{"./terminals-list-element":9,"backbone":"backbone","jquery":"jquery","underscore":"underscore"}],6:[function(require,module,exports){
/* Chèch Lajan
 *
